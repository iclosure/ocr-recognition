...
class JWT_EXPORT JSplitterHandle : public QSplitterHandle
{
    Q_OBJECT
public:
    JSplitterHandle(Qt::Orientation o, QSplitter *parent = nullptr);
...
class JWT_EXPORT JSplitter : public QSplitter
{
    Q_OBJECT
public:
    explicit JSplitter(QWidget *parent = nullptr);
    explicit JSplitter(Qt::Orientation orientation, QWidget *parent = nullptr);
    JSplitter(const QList<double> &scales, QWidget *parent = nullptr);
    JSplitter(const QList<double> &scales, Qt::Orientation orientation, QWidget *parent = nullptr);
    virtual ~JSplitter();
