...
class JWT_EXPORT JTableItemDelegate : public QStyledItemDelegate
{
    Q_OBJECT
public:
    explicit JTableItemDelegate(QObject *parent = nullptr);
    virtual ~JTableItemDelegate() J_OVERRIDE;
...
class JWT_EXPORT JTableSortFilterModel : public QSortFilterProxyModel
{
    Q_OBJECT
public:
    explicit JTableSortFilterModel(QObject *parent = nullptr);
    ~JTableSortFilterModel() J_OVERRIDE;
...
public:
    explicit JTableView(QWidget *parent = nullptr);
    virtual ~JTableView() J_OVERRIDE;
